...
/**
  ...
  *
  * @see [[lomrf.mln.learning.supervision.metric.EvidenceMetric]]
  * @param matcher a matcher function
  */
final case class AtomMetric(override protected val matcher: Matcher) extends StructureMetric[AtomicFormula] {
